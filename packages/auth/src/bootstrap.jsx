...
var mount = function (el, _a) {
    var onSignIn = _a.onSignIn, onNavigate = _a.onNavigate, defaultHistory = _a.defaultHistory, initialPath = _a.initialPath;
    ...
    react_dom_1.default.render(<App_1.default onSignIn={onSignIn} history={history}/>, el);
    return {
